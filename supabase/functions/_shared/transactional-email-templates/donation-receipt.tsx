...
const DonationReceiptEmail = ({ donorName, donorEmail, amount }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Thank you for your donation to {SITE_NAME}!</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          {donorName && donorName !== 'Anonymous' ? `Dear ${donorName}, y` : 'Y'}our generous donation to {SITE_NAME} makes a real difference. Every dollar helps support our mission.
        </Text>
...
export const template = {
  ...
  subject: (data: Record<string, any>) =>
    `Donation Receipt — $${data.amount || 0} — ${SITE_NAME}`,
