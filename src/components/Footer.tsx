  ...
  return (
    <footer className="bg-[#1A1A1A] text-white">
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 text-sm text-white/60">
              <Link to="/register" className="hover:text-primary transition-colors">Participate</Link>
              <Link to="/register#sponsor" className="hover:text-primary transition-colors">Sponsor</Link>
              <Link to="/register#donate" className="hover:text-primary transition-colors">Donate</Link>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 text-xs text-white/30 flex items-center justify-between">
