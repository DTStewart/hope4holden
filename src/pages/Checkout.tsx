        ...
        <form onSubmit={handleCheckout} className="space-y-8">
          ...
          {hasSponsorship && (
            <div className="bg-white p-8 border border-[#1A1A1A]/10 rounded space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="sponsorBusinessName" className="text-[#1A1A1A] font-medium">Business or Sponsor Name *</Label>
                <Input id="sponsorBusinessName" name="sponsorBusinessName" value={form.sponsorBusinessName} onChange={handleChange} required className="rounded border-[#1A1A1A]/15" placeholder="e.g. Acme Corp or Jane Smith" />
                <p className="text-xs text-[#1A1A1A]/50">How you'll be recognized — on event signage, our sponsor list, and thank-you posts. Businesses: enter your business name. Individual supporters: enter your name.</p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
